					...
					<div class="col-sm-9 primary right-content">
						<div class="content-w">
							...
							<div class="news-content">
								Cảm ơn bạn đã quan tâm đến Thế Giới Nước Hoa. Để đăng ký vui lòng điền đầy đủ các thông tin dưới đây.
								<div id="form">
									<form class="form-horizontal" action="UserControl" method="post">
										<span class="form-title">Thông tin cá nhân</span>
									  	...
									  	<div class="form-group">
										    <div class="col-sm-offset-3 col-sm-8">
										     	<button type="submit" name="btAction" value="Register" disabled="disabled" class="btn btn-default" id="buttonRegis">Đăng ký</button>
										    </div>
										</div>
